...
\begin{enumerate}
\item A majority of mining power is unaffected by censorship, meaning that the minority of mining power behind the censor cannot send/receive messages containing a blacklisted word.
\item A minority of mining power is unaffected by censorship, meaning that the majority of mining power behind the censor cannot send/receive messages containing a blacklisted word.
